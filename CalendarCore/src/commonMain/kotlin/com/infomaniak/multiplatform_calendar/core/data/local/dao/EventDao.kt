...
internal abstract class EventDao {
    ...
    private companion object {
        ...
        /**
         * Widens all-day overrides by the widest IANA UTC offset (±14 h), mirroring `MAX_UTC_OFFSET_MS`
         * in `RecurrenceRuleToBoundsEntity`. `CASE` on `isAllDay` keeps zoned overrides exact — they
         * already carry a true instant — while the surplus rows an all-day match lets through are
         * discarded by the expander.
         */
        private const val ALL_DAY_PADDING = "(CASE WHEN override.isAllDay THEN 50400000 ELSE 0 END)"
