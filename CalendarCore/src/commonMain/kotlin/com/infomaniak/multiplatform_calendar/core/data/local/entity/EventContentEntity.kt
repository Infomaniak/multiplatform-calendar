 ...
 *
 * A `RECURRENCE-ID` override redefines the very same properties, so [EventOverrideEntity] embeds
 * this block instead of redeclaring them. [EventEntity] keeps its columns flat and [toContent] maps
 * one onto the other.
 */
...
internal fun EventEntity.toContent(): EventContentEntity = EventContentEntity(
    summary = summary,
