...
internal fun EventEditData.toOverrideEdit(
    ...
    return RemoteEventEdit(
        ...
        alarms = resolveAlarmEdits(alarms, previous = previousAlarms),
        stamp = stamp,
    )
}
 ...
 * emitted form has to preserve the wall-clock [reference] resolved it to. Reading the value on its own
