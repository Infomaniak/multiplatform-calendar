...
private fun RemoteDavEventOverride.resolveOriginalPosition(
    ...
    val masterDomainTiming = masterTiming.toDomain()
    val master = MasterTiming.of(masterDomainTiming, defaultZone = TimeZone.UTC)
    ...
    return OriginalPosition(
        key = masterDomainTiming.recurrenceKeyAt(startLocalDateTime, startInstant),
