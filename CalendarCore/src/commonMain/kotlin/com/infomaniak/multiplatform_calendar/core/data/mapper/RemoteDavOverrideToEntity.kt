...
private fun RemoteDavEventOverride.resolveOriginalPosition(
    ...
    // RFC 5545 §3.8.4.4 wants a floating ID iff a floating DTSTART, and `Z` anchors just like a TZID:
    // the expander drops anchored EXDATE/RDATEs on a floating master for the same reason.
