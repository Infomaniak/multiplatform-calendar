...
/** The VEVENT body of a detached instance, mapped exactly like its master's. */
@Throws(CaldavParsingException::class)
private fun RemoteDavEventContent.toContentEntity(url: String) = EventContentEntity(
    summary = summary ?: "",
