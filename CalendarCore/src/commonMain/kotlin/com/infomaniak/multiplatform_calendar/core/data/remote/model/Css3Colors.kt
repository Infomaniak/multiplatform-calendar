...
/** Resolve a case-insensitive [CSS3 color keyword](https://www.w3.org/TR/css-color-3/#svg-color) to its opaque ARGB, or `null`. */
internal fun parseCss3ColorName(name: String?): Int? {
    if (name == null) return null
    return CSS3_COLORS[name.trim().lowercase()]?.toInt()
}

private val CSS3_COLORS: Map<String, Long> by lazy {
    mapOf(
