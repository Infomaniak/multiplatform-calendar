...
internal class MasterTiming private constructor(
    ...
    /** The worst-case wall-clock span of an occurrence, bounding how far before the window one may still overlap it. */
    val maxOccurrenceDuration: Duration get() = if (isAllDay) allDaySpanDays.days else nominalDuration
